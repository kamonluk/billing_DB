...
require_once "billpayment/Charge.php";
...
try{
   ...
   elseif ($service == "Charge"){
        $transaction = $_POST["transaction"];
		$result = new Charge($transaction["accountNumber"],$transaction["chargeType"]);
		echo json_encode(output2JSON($result->getCharge())); 
   }
